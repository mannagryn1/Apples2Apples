...
public class LocalPlayer extends Player {
    ...
    System.out.println("\n**********************************************************************\n");
            ...
            while(!validCardSelected) {     //create loop to force player to pick a number between 1-7
                ...
                input = br.readLine();
                try{
                    if ((Integer.parseInt(input) <= hand.size() ) && (Integer.parseInt(input) >= 1)){
                    ...
                    System.out.println("Something went wrong while parsing player input " + e);
                }
            }
